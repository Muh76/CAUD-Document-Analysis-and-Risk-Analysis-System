...
def get_config_summary() -> Dict[str, Any]:
    ...
    return {
        ...
        "openai_key_hash": hash_sensitive_data(OPENAI_API_KEY) if OPENAI_API_KEY else "NOT_SET",
        "azure_endpoint_set": bool(AZURE_OPENAI_ENDPOINT),
        "azure_key_set": bool(AZURE_OPENAI_API_KEY),
        "azure_key_hash": hash_sensitive_data(AZURE_OPENAI_API_KEY) if AZURE_OPENAI_API_KEY else "NOT_SET",
