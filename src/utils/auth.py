...
class AuthManager:
    ...
    def validate_access(self, user: Dict, resource: str, action: str) -> bool:
        ...
        try:
            ...
            if role == "user":
                ...
                if action in ["read", "analyze"] and resource in ["contracts", "analysis"]:
                    return True
    ...
    def create_user(self, username: str, email: str, password: str, full_name: str, role: str = "user") -> bool:
        """
        Create new user
    ...
    def get_user_stats(self) -> Dict:
        ...
        try:
            ...
            active_users = sum(1 for user in self.users_db.values() if user.get("active", False))
            admin_users = sum(1 for user in self.users_db.values() if user.get("role") == "admin")
